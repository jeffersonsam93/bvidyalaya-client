...
const fs = require('fs');
var privateKey = fs.readFileSync( '/etc/letsencrypt/live/bharathividyalaya.co.in/privkey.pem' );
var certificate = fs.readFileSync( '/etc/letsencrypt/live/bharathividyalaya.co.in/fullchain.pem' );
